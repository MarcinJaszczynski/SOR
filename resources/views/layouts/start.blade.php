...
<section class="py-5 text-center container landing__top">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto landing__top__text">
        ...
        <p>
          <a href="https://bprafa.pl" class="btn btn-lg btn-primary my-2">Oferta wycieczek</a>
          <p class="lead text-muted">Jeżeli jesteś naszym klientem lub współpraconikiem zapraszamy do Wirtualnego Biura Obługi</p>
