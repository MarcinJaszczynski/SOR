...
<body>
    ...
    <div>ul. Nowogrodzka 42 lok. 501, 04-695 Warszawa, NIP 716-250-87-61, REGON 432298189</div>
    ...
    <div>Obiekt noclegowy: <b> {!! $request->eventHotel !!}</b></div>
    ...
    <div><b>1.1</b> Organizatorem imprez turystycznych o których mowa w niniejszych Warunkach Uczestnictwa jest Biuro Podróży RAFA – Rafał Latos (posługujące się również nazwą handlową Biuro Podróży RAFA, ul. Nowogrodzka 42 lok. 501, 00-695 Warszawa, NIP 716-250-87-61, REGON 432298189, wpis do rejestru Organizatorów i Pośredników Turystycznych nr 1270, posiadające gwarancję ubezpieczeniową organizatora turystyki w Towarzystwie Ubezpieczeniowym Signal Iduna.</div>
