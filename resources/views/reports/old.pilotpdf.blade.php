...
<hr>
    ...
    <div class="formatedText"><pre>{!! $event->eventPilotNotes !!}</pre></div>
    ...
    <table  class="tablebordered">
        ...
        <tr>
            <td class="tdbordered">{{ $payment->paymentName }}<br>{{ $payment->paymentNote }}</td>
        ...
        <tr><td colspan="4" class="titleclass2 tdbordered">Razem: {{ $event->pilotSum($event->id) }}</td><td colspan="3" class="titleclass2 tdbordered">
            Wydano: </td>
        </tr>
        <tr><td colspan="4" class="titleclass2 tdbordered">Zaliczka dla pilota: {{ $event->eventAdvancePayment }}</td><td colspan="3" class="titleclass2 tdbordered">
            Do zwrotu: </td>
        </tr>
    </table>
...
<hr>
    ...
    <tr>
        ...
        <tr>
        <td class="titleclass2"><a href="/storage/{{ $file->fileName }}" download>{{ $file->fileName }}</a></td>
