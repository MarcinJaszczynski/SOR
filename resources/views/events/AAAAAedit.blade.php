                        ...
                        <div class="col-md-3">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                    {{ Form::input('dateTime-local', 'eventStartDateTime', date('Y-m-d\TH:i',  strtotime($event->eventStartDateTime)) , ['id' => 'eventStartTime', 'class' => 'form-control']) }} </div>
                                    <hr>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                                <th>nazwa</th><th>notatki</th><th>pilot</th><th>hotel</th><th>operacje</th>
                            </thead>
