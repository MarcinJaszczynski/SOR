...
<tr>
        ...
        <td><div class="btn-group float-end" role="group" aria-label="Basic example" >
...
@endforeach
    ...
    <tr>
    <td colspan="8"></td>
    <td colspan="2" ><h4 class="float-end">Wydatki łącznie:</h4></td>
    <td colspan="2"><h4>{{ $event->totalSum($event->id) }}</h4></td>
    </tr>
    <tr>
    <td colspan="8"></td>
    <td colspan="2" ><h5 class="float-end">Zapłacone:</h5></td>
    <td colspan="2"><h5>{{ $event->paidSum($event->id) }}</h5></td>
    </tr>
    <tr>
    <td colspan="8"></td>
    <td colspan="2"><h5 class="float-end">Pozostało:</h5>
    <td colspan="2"><h5>{{ $event->totalSum($event->id) - $event->paidSum($event->id) }}</h5></td>
    </tr>
    <tr>
    <td colspan="8"></td>
    <td colspan="2"><h5  class="float-end">Wydatki pilota:</h5></td>
    <td colspan="2"><h5>{{ $event->pilotSum($event->id) }}</h5>
<div><strong>zaliczka: </strong>{{ $event->	eventAdvancePayment }} </td>
    </tr>
